# Blockchain
# Hash function - alg that converts len of str of arbitrary to bits of fixed len 
#BlockChain.py
...
class someClass:
    ...
    def __repr__(self):
#         note num much be included to avoid tempering
...
if __name__ == '__main__':
    ...
    if B1.computeHash() == B3.previousHash:
        print('It worked')
    else:
        print('Try again')
